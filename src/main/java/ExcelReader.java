...
public class ExcelReader {
    ...
    public static List<University> readExcelUniversities(String filePath) throws IOException {
        ...
        while (rows.hasNext()) {
            ...
            university.setMainProfile(currentRow.getCell(4).getStringCellValue());
        }

        return universities;
    }

    public static List<Student> readExcelStudents(String filePath) throws IOException {
